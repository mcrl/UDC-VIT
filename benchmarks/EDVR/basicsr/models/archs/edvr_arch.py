...
class EDVR(nn.Module):
    ...
    def __init__(self,
        ...
        # upsample
        self.upconv1 = nn.Conv2d(num_feat, num_feat, 3, 1, 1) # kyusu: num_feat * 4 -> num_feat
        self.upconv2 = nn.Conv2d(num_feat, 64, 3, 1, 1) # kyusu: 64 * 4 -> 64
        self.pixel_shuffle = nn.PixelShuffle(1) # kyusu: 2 -> 1
    ...
    def forward(self, x):
        ...
        if self.hr_in:
            ...
            base = F.interpolate(
                x_center, scale_factor=1, mode='bilinear', align_corners=False) # kyusu: scale_factor=4 -> 1
        out += base
        return out
