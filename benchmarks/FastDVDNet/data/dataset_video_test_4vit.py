...
class VideoRecurrentTestDataset4Vit(data.Dataset):

    def __init__(self, opt):
        super(VideoRecurrentTestDataset4Vit, self).__init__()
        self.opt = opt
        ...
        print(">>>>>>>>>>>>>>>>>>>> NUM OF VIDEOS FOR TEST:", "/", len(self.video_list_gt))
    ...
    def __getitem__(self, index):
        ...
        # print("========> self.gt_root:", self.gt_root)
        # print("========> img_gt_path:", img_gt_path)
        # print("========> img_gt_path:", img_gt_path.split('/')[0])
        # print("========> img_gt_path:", img_gt_path.split('/')[1])
        # print("========> H_filename:", img_gt_path.split('/')[1].split('.')[0])
        # randomly crop
        ...
        return {'L': img_lqs, 'H':img_gts, 'H_folder': img_gt_path.split('/')[0], 'H_filename': img_gt_path.split('/')[1].split('.')[0]}
