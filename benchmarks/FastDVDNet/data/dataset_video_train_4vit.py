...
class VideoRecurrentTrainDataset4Vit(data.Dataset):
    def __init__(self, opt):
        super(VideoRecurrentTrainDataset4Vit, self).__init__()
        self.opt = opt
        ...
        self.video_list_gt = [f.path for f in os.scandir(self.gt_root) if f.is_dir()]#[:1] 
    ...
    def __getitem__(self, index):
        ...
        img_results = utils_video.augment(img_lqs, hflip=False, vflip=self.opt['use_hflip'], rotation=self.opt['use_rot'], flows=None)
