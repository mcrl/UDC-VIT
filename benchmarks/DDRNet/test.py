...
def main():
    ...
    parser.add_argument('--task', type=str, default='ddrnet_udc_vit', help='tasks')
    parser.add_argument('--folder_lq', type=str, default='UDC-VIT/test',
                        help='input low-quality test video folder') 
    parser.add_argument('--folder_gt', type=str, default='UDC-VIT/test',  
                        help='input ground-truth test video folder')

    parser.add_argument('--tile', type=int, nargs='+', default=[10,0,0] ,   #[50,256,256],
    ...
    parser.add_argument('--io_backend',type=str, default={"type": "npy"})
    ...
    test_set = VideoRecurrentTestDataset({'dataroot_gt':args.folder_gt, 'dataroot_lq':args.folder_lq,
                                        'num_frame':-1, 'cache_data': False, 'io_backend':args.io_backend})
    ...
    for idx, batch in enumerate(test_loader):
        ...
        print("time per 1 folder", end-start)
...
def prepare_model_dataset(args):
    ...
    model_path = '../checkpoints/DDRNet/400000_G.pth'
