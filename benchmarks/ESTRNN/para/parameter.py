...
class Parameter:
    ...
    def extract_args(self):
        ...
        self.parser.add_argument('--num_gpus', type=int, default=4, help='# of GPUs to use')
        self.parser.add_argument('--no_profile', action='store_true', help='show # of parameters and computation cost')
        self.parser.add_argument('--profile_H', type=int, default=1060,
                                 help='height of image to generate profile of model')
        self.parser.add_argument('--profile_W', type=int, default=1900,
        ...
        self.parser.add_argument('--dataset', type=str, default='UDC-VIT', help='BSD, gopro_ds_lmdb, reds_lmdb') 
        ...
        self.parser.add_argument('--ds_config', type=str, default='npy', help='1ms8ms, 2ms16ms or 3ms24ms')
        ...
        self.parser.add_argument('--trainer_mode', type=str, default='ddp',
